...
function verificar(obj) {
	...
	var tag_obj = obj.tagName;
	var chkbx = "n";
	var busca;
	var id_busca = "";
	var busca_exata = "n";
	
	if (tag_obj == "INPUT" || tag_obj == "input") {
		if (obj.getAttribute('type') == "checkbox" || obj.getAttribute('type') == "CHECKBOX") {
			chkbx = "s";
			if (obj.checked == true && obj.parentElement.parentElement.id == "buscas") {
				//busca_exata = "s";
				id_objtmp = obj.id.substr(6,obj.id.length);
			}
		/*} else {
	...
	var coltmp;
	var cmptmp;
	var linha_campos = document.getElementById("campos");
	...
	for (var l = 1; l <= linhas.length; l++) {
		...
		if (linha_atual != null) {
			...
			colunastmp = linha_atual.getElementsByTagName("td");
			for (var col = 0; col < colunastmp.length; col++) {
				coltmp = document.getElementById(colunastmp[col].id); // aqui seleciona a coluna atual da linha atual
				coluna_tmp = document.getElementById(colunas[col].id); // aqui seleciona uma coluna da linha "campos"
				cmptmp = coluna_tmp.getElementsByTagName("input");
				inputtmp = cmptmp[0];
				//alert(inputtmp.id);
				txt_obj = inputtmp.value.trim();
				coltmp.className = "normal";
...
<table width="100%" id="tbl_concursos">
	...
	<tr id="buscas">
		<td id="col_busca_concurso">
			<input type="checkbox" name="busca_concurso" id="busca_concurso" onChange="verificar(this)"/><br/>
			<label for="busca_concurso">Exato?</label>
		</td>
		<td id="col_busca_data_sorteio">
			<input type="checkbox" name="busca_data_sorteio" id="busca_data_sorteio" onChange="verificar(this)"/><br/>
			<label for="busca_data_sorteio">Exato?</label>
		</td>
		<td id="col_busca_dezena1">
			<input type="checkbox" name="busca_dezena1" id="busca_dezena1" onChange="verificar(this)"/><br/>
			<label for="busca_dezena1">Exato?</label>
		</td>
		<td id="col_busca_dezena2">
			<input type="checkbox" name="busca_dezena2" id="busca_dezena2" onChange="verificar(this)"/><br/>
			<label for="busca_dezena2">Exato?</label>
		</td>
		<td id="col_busca_dezena3">
			<input type="checkbox" name="busca_dezena3" id="busca_dezena3" onChange="verificar(this)"/><br/>
			<label for="busca_dezena3">Exato?</label>
		</td>
		<td id="col_busca_dezena4">
			<input type="checkbox" name="busca_dezena4" id="busca_dezena4" onChange="verificar(this)"/><br/>
			<label for="busca_dezena4">Exato?</label>
		</td>
		<td id="col_busca_dezena5">
			<input type="checkbox" name="busca_dezena5" id="busca_dezena5" onChange="verificar(this)"/><br/>
			<label for="busca_dezena5">Exato?</label>
		</td>
		<td id="col_busca_dezena6">
			<input type="checkbox" name="busca_dezena6" id="busca_dezena6" onChange="verificar(this)"/><br/>
			<label for="busca_dezena6">Exato?</label>
		</td>
		<td id="col_busca_arrecadacao_total">
			<input type="checkbox" name="busca_arrecadacao_total" id="busca_arrecadacao_total" onChange="verificar(this)"/><br/>
			<label for="busca_arrecadacao_total">Exato?</label>
		</td>
		<td id="col_busca_ganhadores_sena">
			<input type="checkbox" name="busca_ganhadores_sena" id="busca_ganhadores_sena" onChange="verificar(this)"/><br/>
			<label for="busca_ganhadores_sena">Exato?</label>
		</td>
		<td id="col_busca_cidade">
			<input type="checkbox" name="busca_cidade" id="busca_cidade" onChange="verificar(this)"/><br/>
			<label for="busca_cidade">Exato?</label>
		</td>
		<td id="col_busca_uf">
			<input type="checkbox" name="busca_uf" id="busca_uf" onChange="verificar(this)"/><br/>
			<label for="busca_uf">Exato?</label>
		</td>
		<td id="col_busca_rateio_sena">
			<input type="checkbox" name="busca_rateio_sena" id="busca_rateio_sena" onChange="verificar(this)"/><br/>
			<label for="busca_rateio_sena">Exato?</label>
		</td>
		<td id="col_busca_ganhadores_quina">
			<input type="checkbox" name="busca_ganhadores_quina" id="busca_ganhadores_quina" onChange="verificar(this)"/><br/>
			<label for="busca_ganhadores_quina">Exato?</label>
		</td>
		<td id="col_busca_rateio_quina">
			<input type="checkbox" name="busca_rateio_quina" id="busca_rateio_quina" onChange="verificar(this)"/><br/>
			<label for="busca_rateio_quina">Exato?</label>
		</td>
		<td id="col_busca_ganhadores_quadra">
			<input type="checkbox" name="busca_ganhadores_quadra" id="busca_ganhadores_quadra" onChange="verificar(this)"/><br/>
			<label for="busca_ganhadores_quadra">Exato?</label>
		</td>
		<td id="col_busca_rateio_quadra">
			<input type="checkbox" name="busca_rateio_quadra" id="busca_rateio_quadra" onChange="verificar(this)"/><br/>
			<label for="busca_rateio_quadra">Exato?</label>
		</td>
		<td id="col_busca_acumulado">
			<input type="checkbox" name="busca_acumulado" id="busca_acumulado" onChange="verificar(this)"/><br/>
			<label for="busca_acumulado">Exato?</label>
		</td>
		<td id="col_busca_valor_acumulado">
			<input type="checkbox" name="busca_valor_acumulado" id="busca_valor_acumulado" onChange="verificar(this)"/><br/>
			<label for="busca_valor_acumulado">Exato?</label>
		</td>
		<td id="col_busca_estimativa_premio">
			<input type="checkbox" name="busca_estimativa_premio" id="busca_estimativa_premio" onChange="verificar(this)"/><br/>
			<label for="busca_estimativa_premio">Exato?</label>
		</td>
		<td id="col_busca_acumulado_megadavirada">
			<input type="checkbox" name="busca_acumulado_megadavirada" id="busca_acumulado_megadavirada" onChange="verificar(this)"/><br/>
