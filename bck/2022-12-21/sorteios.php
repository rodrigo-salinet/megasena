...
<body>
<form id="frm_megasena" name="frm_megasena">
    <table id="tbl_cabecalho">
        <tr id="exibicao">
            <td id="col_exibicao">
                <input type="checkbox" name="exibir" id="exibir" onChange="megasena.ocultarExibirLinhas()"/>
                <label for="exibir">Só destaques</label>
            </td>
            <td id="col_mais_sorteados"></td>
            <td id="col_mais_sorteados2"></td>
        </tr>
    </table>
    <table id="tbl_campos">
        <tr id="campos">
    ...
    <table id="tbl_concursos">
        ...
        <tr class="<?php echo $classe; ?>" id="linha_<?php echo $id_concurso; ?>">
            ...
            <td id="dezena1_<?php echo $id_concurso; ?>"><?php echo $dezena1; ?></td>
            <td id="dezena2_<?php echo $id_concurso; ?>"><?php echo $dezena2; ?></td>
            <td id="dezena3_<?php echo $id_concurso; ?>"><?php echo $dezena3; ?></td>
            <td id="dezena4_<?php echo $id_concurso; ?>"><?php echo $dezena4; ?></td>
            <td id="dezena5_<?php echo $id_concurso; ?>"><?php echo $dezena5; ?></td>
            <td id="dezena6_<?php echo $id_concurso; ?>"><?php echo $dezena6; ?></td>
        </tr>
        <?php
                if ($classe == "cor1") {
                    $classe = "cor2";
    ...
    <table id="tbl_notificacoes">
        <tr>
            <td id="col_qtd_destaques">Qtd destaques:</td>
            <td id="col_destaques">0</td>
            <td id="col_notificacoes"><b>Notificações:</b></td>
            <td id="col_txt_notificacoes"><textarea id="txt_notificacoes" rows="2" cols="20" placeholder="Aqui serão exibidas as notificações"></textarea></td>
        </tr>
    </table>
